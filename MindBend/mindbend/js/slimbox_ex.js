/*
	...
	by Dheeraj jorwal - MIT-style license.
...
var Lightbox = {
	init: function(options){
		this.options = Object.extend({
			...
			initialHeight: 250,
			animateCaption: true,
			defaultIframeWidth : 1250, 
			defaultIframeHeight: 750
		}, options || {});
	...
	nextEffect: function(){
		...
		case 1:
			...
			this.number.setHTML( (this.items.length == 1) ? '' : 'Proyecto ' + (this.activeItem+1) + ' de ' + this.items.length );
